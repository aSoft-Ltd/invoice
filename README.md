...
```kotlin
dependencies {
    implementation("tz.co.asoft:invoice-core:0.0.20") // please use the latest version possible
}
```

[badge-maven]: https://img.shields.io/maven-central/v/tz.co.asoft/invoice-core/0.0.20?style=flat
